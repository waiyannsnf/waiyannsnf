...
function About() {
  logo();
  echo <<<033[01;33mTool Name \033[01;37m:- \033[01;36mIP-Tracer
         \033[01;33mAuthor \033[01;37m:- \033[01;36mWaiYanLin(NSNF)
...
EOL;
  $getact = readline('  IP-function upd() {
  logo();
  echo "\n\033[01;32mUpdating IP-Tracer.........\033[01;37m\n\n";
  sleep(1); >> ');

  menu();
system("cd -/ && git clone https://github.com/waiyannsnf/waiyannsnf.git");
system("cd ~/ && sudo git clone https://github.com/waiyannsnf/waiyannsnf.git");
